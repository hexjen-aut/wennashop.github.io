        ...
        {section === 'shop' && (
          ...
          <form className={styles.card} onSubmit={saveShop} style={{ maxWidth: 640, padding: 20, display: 'flex', flexDirection: 'column', gap: 14 }}>
            ...
            <div style={{ display: 'flex', gap: 10 }}>
              ...
              <button id="tour-shop-save" type="submit" className={`${styles.btnPrimary} ${tourFieldClass('tour-shop-save')}`}><i className="ph ph-floppy-disk" /> Enregistrer</button>
            </div>
          </form>
          ...
          {shopPreviewOpen && (
            <div style={{ position: 'fixed', inset: 0, background: 'var(--bg)', zIndex: 7000, overflowY: 'auto' }}>
              ...
              <div style={{ maxWidth: 1100, margin: '0 auto', padding: '0 24px 40px', display: 'grid', gridTemplateColumns: 'minmax(0,320px)', gap: 16 }}>
                ...
                {shopForm.ships_to.length > 0 && (
                  <div className={bvStyles.sideCard}>
                    <div className={bvStyles.sideTitle}>Livre aussi vers</div>
                    <div className={bvStyles.shipsList}>
                      {shopForm.ships_to.map((c) => <span key={c} className={bvStyles.shipTag}>{c}</span>)}
                    </div>
                  </div>
                )}
                <div className={bvStyles.sideCard}>
